...
class TweetTestCase(TestCase):
    ...
    def test_tweet_list(self):
        ...
        # print(response.json())      returns => [{'id': 3, 'content': 'my first tweet', 'likes': 0, 'is_retweet': False, 'parent': None}, {'id': 2, 'content': 'my first tweet', 'likes': 0, 'is_retweet': False, 'parent': None}, {'id': 1, 'content': 'my first tweet', 'likes': 0, 'is_retweet': False, 'parent': None}]
